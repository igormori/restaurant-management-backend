...
The Organization entity is in Entities/ Organization.cs (leading space in the filename)
and shares its name with the module's own namespace segment, so it must stay referenced
as Entities.Organization in the DbContext and services to avoid ambiguity.
